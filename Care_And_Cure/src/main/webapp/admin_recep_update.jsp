<%-- 
    Document   : admin_recep_update
    Created on : 14 May 2021, 01:02:59
    Author     : alex
--%>
        ...
        <div class="container">
            <div class="card bg-light">
                <article class="card-body mx-auto" style="max-width: 400px;">
                    ...
                    <form action="Admin_update_recep" method="post">
                        <%
                            ResultSet rs = null;
            
                            String num = request.getParameter("recepid");

                            PreparedStatement ps = con.createConnection().prepareStatement("select * from reg_reception where recep_id = ?");
                            ps.setString(1, num);
                            rs = ps.executeQuery();
                        ...
                        %>
                         <div>${status}</div>
                        <input type="hidden" name="id" value="<%= rs.getInt("recep_id")%>"/>
                        ...
                        <div class="form-group input-group">
                         ...
                         <div class="form-group input-group">
                            ...
                            <input name="phone_no" class="form-control" value="<%= rs.getString("phone_no")%>" type="text">
                        </div> <!-- form-group// -->
