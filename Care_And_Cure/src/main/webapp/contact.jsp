<%-- 
    Document   : contact
    Created on : 25 Apr 2021, 22:47:10
    Author     : alex
--%>
            ...
            <section id="contact" class="contact">
                <div class="container">
                    ...
                    <div class="section-title">
                        <h2>Contact</h2>
                        <p>Have a suggestion or want to know more information? Contact Us.</p>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-4">
                            <div class="info">
                                <div class="address">
                                    ...
                                    <h4>Location:</h4>
                                    <p>A108 Baker Street, Colombo, Sri Lanka 11870</p>
                                </div>

                                <div class="email">
                                    <i class="icofont-envelope"></i>
                                    <h4>Email:</h4>
                                    <p>careAndcure@gmail.com</p>  
                        ...
                        <div class="col-lg-8 mt-5 mt-lg-0">
                            ...
                            <form action="Contact_send" method="post" role="form" class="php-email-form">
                                <div class="form-row">
