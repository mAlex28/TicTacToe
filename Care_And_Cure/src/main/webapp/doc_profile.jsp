<%-- 
    ...
    Created on : 11 May 2021, 00:10:21
    Author     : alex
--%>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="Update_doctor_pass">
        ...
        <div class="container">
            <div class="card bg-light">
                <article class="card-body mx-auto" style="max-width: 400px;">
                    ...
                    <form action="Doc_update_doctor" method="post">
                        <div>${status}</div>
                        <%
                            ...
                            PreparedStatement ps = con.createConnection().prepareStatement("select * from doctor where username like '%" + username + "%'");
                            rs = ps.executeQuery();
                       ...
                       <div class="form-group input-group">
                        ...
                        <div class="form-group input-group">
                            ...
                            <select name="department" class="form-control">
                                ...
                                <% while (resdp.next()) {%>
                                <option value="<%= resdp.getString("dep_id")%>"><%= resdp.getString("dep_name")%></option>
                                <%  } %>
                            </select>
                        </div> <!-- form-group end.// -->
