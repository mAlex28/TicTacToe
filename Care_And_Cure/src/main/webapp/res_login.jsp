<%-- 
    Document   : res_login
    Created on : 25 Apr 2021, 22:08:04
    Author     : alex
--%>
...
<%
    ...
    if (session.getAttribute("username") != null) {
        response.sendRedirect("/CareAndCure/recep_home.jsp");
    }
%>
<!DOCTYPE html>
<html>
    <head>
        ...
        <link href="./assets/css/res_login.css" rel="stylesheet">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-8 login-box">
                        ...
                        <%
                            //No access if credentials are invalid
                        //    if (session.getAttribute("status") != null) {
                        //        out.println("<div class='alert alert-danger' role='alert'>"+ session.getAttribute("status")+"</div>");
                        //    }
                        %>
