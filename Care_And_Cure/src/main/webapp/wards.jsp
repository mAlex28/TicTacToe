<%-- 
    Document   : wards
    Created on : 11 May 2021, 22:16:56
    Author     : alex
--%>
            ...
            <div class="d-flex justify-content-center">
                ...
                <table class="table table-striped table-bordered table-responsive table-light pdatatable">
                    ...
                    <tbody>
                        <%
                            try {
                                ResultSet rs = ward.getAllWardPatients();
                                while (rs.next()) {
                        ...
                        %>
                        <tr>
                            <td><%= rst.getString("ward_name")%></td>
                            <td><%= rsp.getString("fname")%> <%= rsp.getString("lname")%></td>
                            <td><%= rs.getString("admit_date")%></td>
                            <td><%= rs.getString("release_date")%></td>
                            <td><%= rs.getString("status")%></td>
                            <td> 
                                <form method="post" action="ward_update.jsp">
                                    <input type="hidden" value="<%= rs.getInt("id")%>" name="id">
                                    <input type="submit" value="Update" class="btn btn-warning">
                                </form> 
                            </td>
                            <td>
                                <form method="post" action="Delete_ward">
                                    <input type="hidden" value="<%= rs.getInt("id")%>" name="id">
